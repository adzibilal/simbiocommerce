            ...
            <div className="flex flex-col gap-1">
              ...
              {openMenus.storeSettings && (
                <div className="flex flex-col gap-1 mt-1 ml-6">
                  ...
                  <Link className="flex items-center font-normal rounded-lg gap-2.5 py-2.5 px-3 text-sm ease-out duration-200 hover:bg-blue/10 hover:text-blue text-dark-2 bg-transparent" href="/admin/store-settings/email">Email Settings</Link>
