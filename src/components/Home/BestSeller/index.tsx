  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const activeProducts = data.filter(p => p.isActive).slice(0, 6);
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7.5">
            {[...Array(6)].map((_, key) => (
              <div key={key} className="animate-pulse">
                <div className="bg-gray-2 h-[270px] rounded-lg mb-4"></div>
                <div className="h-4 bg-gray-2 rounded mb-2"></div>
